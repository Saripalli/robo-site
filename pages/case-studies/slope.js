// pages/case-studies/slope.js
import Head from "next/head";
import Header from "../../components/Header";
import RightMenuLayout from "../../components/RightMenuLayout";

export default function SlopeCase() {
  const pdfPath = "/case-studies/springle_kikato_slope.pdf";

  return (
    <>
      <Head>
        <title>Navigating Slopes with Kikato — Case Study</title>
      </Head>
      ...
      <main style={{ padding: "32px 20px", background: "#fdf8f3", minHeight: "80vh" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <h1 style={{ color: "#2E7D32" }}>Navigating Slopes with Kikato</h1>
          <p style={{ color: "#444" }}>How a restaurant managed an 11-degree incline with Kikato. Read online or download below.</p>
