// pages/case-studies/kikato-cafe.js
import Head from "next/head";
import Header from "../../components/Header";
import RightMenuLayout from "../../components/RightMenuLayout";

export default function KikatoCafe() {
  const pdfPath = "/case-studies/springle_kikato_cafe.pdf";

  return (
    <>
      <Head>
        <title>Kikato in a CBD Coffee Lounge — Case Study</title>
      </Head>
      ...
      <main style={{ padding: "32px 20px", background: "#fdf8f3", minHeight: "80vh" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <h1 style={{ color: "#2E7D32" }}>Kikato in a CBD Coffee Lounge</h1>
          <p style={{ color: "#444" }}>One-month pilot case study. Read online or download below.</p>
